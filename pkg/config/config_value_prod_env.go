...
var config = Value{
	...
	MongoConfig: MongoConfig{
		ConnectionString: "mongodb://sagamarket:S+n7eL1+rSZKtxzC@sagemarket-prod-mongo.cluster-cburg362yfls.ap-northeast-1.docdb.amazonaws.com:27017/ont?replicaSet=rs0&readpreference=secondaryPreferred",
